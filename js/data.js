...
let RECORDS = [
  ...
  },
  {
    ...
    history: [
      ...
      { when: '2026-06-04 09:00', who: 'Patrícia (Aprovação)', what: 'Contrato 0887 lançado na administradora · venda concluída' },
    ],
  },
  ...
  // ── Kamila (g36 · Bell Breakers / Eagles) ──
  {
    ...
    history: [
      ...
      { when: '2026-06-02 17:00', who: 'Patrícia (Aprovação)', what: 'Contrato 0905 lançado na administradora · venda concluída' },
    ],
  },
